//Trydent Cypress Test Code
describe("Trydent E2E Test", () => {
  beforeEach(() => {
    cy.visit("http://localhost:3000/");
  });

  it("should run through standard work flow and have ability to start again", () => {
    ...
    cy.xpath(
      '//div[@id="root"]/div[1]/div[2]/details[1]/div[1]/summary[1]/h3[1]'
    ).should("exist");
    cy.xpath(
      '//div[@id="root"]/div[1]/div[2]/details[1]/div[1]/summary[1]/h3[1]'
    )
    ...
    cy.xpath('//div[@id="root"]/div[1]/div[2]/details[1]/div[1]/ol[1]/li[5]')
      ...
      .and("be.visible");
    cy.xpath(
      '//div[@id="root"]/div[1]/div[2]/details[1]/div[2]/p[1]/h3[1]'
    ).should("exist");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/details[1]/div[2]/p[1]/h3[1]')
      .should("have.html", "Capturing assertions:")
      .and("be.visible");
    ...
    cy.xpath('//div[@id="root"]/div[1]/div[2]/summary[1]').should("exist");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/summary[1]').click({
      force: true,
    });
    cy.xpath('//button[@id="startRecording"]').should("exist");
    ...
    cy.xpath('//div[@id="root"]/div[1]/div[2]/div[1]/h1[1]')
      ...
      .and("be.visible");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/p[1]/a[1]').should("exist");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/p[1]/a[1]')
      .should("have.html", "Github")
      .and("be.visible");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/span[1]/span[1]').should("exist");
    ...
    cy.xpath('//div[@id="root"]/div[1]/div[2]/p[1]').should("exist");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/p[1]').click({ force: true });
    cy.xpath('//div[@id="root"]/div[1]/div[2]/div[1]').should("exist");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/div[1]')
      .should(
        "have.html",
        '<h1>Generated Test</h1><div class="copy-button"><button class="copied" disabled="">Copied to clipboard!</button></div>'
      )
      .and("be.visible");
    cy.xpath('//div[@id="root"]/div[1]/div[2]/div[1]').should(
      "have.class",
      "head"
    );
    cy.xpath('//div[@id="root"]/div[1]/div[1]/div[2]/button[1]').should(
